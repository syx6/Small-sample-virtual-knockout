...
def run_paper_benchmark(args: argparse.Namespace) -> None:
    ...
    print(f"  figures: {args.out_dir}\\00_publication_main_figure.png")
    print(f"           {args.out_dir}\\01_method_leaderboard.png")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    formal = sub.add_parser("formal-benchmark", help="Run a formal method benchmark: VKX variants vs PLS/Ridge/Additive plus external scGen/CPA/GEARS/CellOT predictions when provided.")
